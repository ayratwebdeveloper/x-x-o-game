...
function gameOver(a) {
    var gameOverAlertElement = "<b>Игра завершенна </b><br><br> Игрок " + span[a].dataset.player.toUpperCase() + ' Выиграл <br><br>' + restartButton;
...
function draw() {
    var drawAlertElement = '<b>Ничья</b><br><br>' + restartButton;
    var div = document.createElement("div");
    div.className = "alert";
